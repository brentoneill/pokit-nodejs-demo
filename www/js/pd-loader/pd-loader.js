...
angular.module('pdLoader').factory('_cgBusyTrackerFactory',['$timeout','$q',function($timeout,$q){
...
angular.module('pdLoader').value('pdLoaderDefaults',{});

angular.module('pdLoader').directive('pdLoader',['$compile','$templateCache','pdLoaderDefaults','$http','_cgBusyTrackerFactory',
    function($compile,$templateCache,pdLoaderDefaults,$http,_cgBusyTrackerFactory){
        return {
            restrict: 'A',
            link: function(scope, element, attrs, fn) {
                ...
                scope.$watchCollection(attrs.pdLoader,function(options){
                    ...
                    if (angular.isString(options)) {
                        throw new Error('Invalid value for cg-busy. pdLoader no longer accepts string ids to represent promises/trackers.');
                    }
